...
public class Main extends Application
{
    ...
    public void start(Stage window) 
    {
        ...
        //Create a bank account with an overdraft, with the fourth element being the overdraft ammount
        OverdraftAccount overdraftAccount = new OverdraftAccount(10003, 69696, 1020, 5000);
        b.addBankAccount(overdraftAccount);
